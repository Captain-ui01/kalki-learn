function initNetworkingCourse() {
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createConfetti() {
                const colors = ['#34495e', '#2c3e50', '#3498db', '#2ecc71', '#e74c3c'];
                for (let i = 0; i < 100; i++) {
...
// Run on normal load
document.addEventListener('DOMContentLoaded', initNetworkingCourse);

// Run when SPA loads this page
document.addEventListener('page:loaded', (e) => {
  if (e.detail === 'datascience-page') {
    initNetworkingCourse();
  }
});        