        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            enrollButton.addEventListener('click', function(e) {
                ...
                setTimeout(() => {
                    ...
                    this.style.background = 'linear-gradient(135deg, #ff6b6b 0%, #ffc107 100%)';
                    this.style.animation = 'glow 2s infinite';
                }, 3000);
            });
            
            function createConfetti() {
                const colors = ['#ff6b6b', '#ffc107', '#17a2b8', '#28a745', '#6f42c1'];
                for (let i = 0; i < 100; i++) {
...
// Run on normal load
document.addEventListener('DOMContentLoaded', initMLCourse);
