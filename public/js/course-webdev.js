        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            enrollButton.addEventListener('click', function(e) {
                ...
                setTimeout(() => {
                    ...
                    this.style.background = 'linear-gradient(135deg, #2980b9 0%, #3498db 100%)';
                    this.style.animation = 'glow 2s infinite';
                }, 3000);
            });
            
            function createConfetti() {
                const colors = ['#2980b9', '#3498db', '#2ecc71', '#28a745', '#9b59b6'];
                for (let i = 0; i < 100; i++) {
...
// Run on normal load
document.addEventListener('DOMContentLoaded', initWebDevCourse);
