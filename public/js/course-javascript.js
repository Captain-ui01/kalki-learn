        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            enrollButton.addEventListener('click', function(e) {
                ...
                setTimeout(() => {
                    ...
                    this.style.background = 'linear-gradient(135deg, #f1c40f 0%, #f39c12 100%)';
                    this.style.animation = 'glow 2s infinite';
                }, 3000);
            });
            
            function createConfetti() {
                const colors = ['#f1c40f', '#f39c12', '#3498db', '#2ecc71', '#9b59b6'];
                for (let i = 0; i < 100; i++) {
...
// Run on normal load
document.addEventListener('DOMContentLoaded', initJavaScriptCourse);

// Run when SPA loads this page
document.addEventListener('page:loaded', (e) => {
  if (e.detail === 'datascience-page') {
    initJavaScriptCourse();
  }
});
