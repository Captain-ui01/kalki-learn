function initMobileDevCourse() {
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createConfetti() {
                const colors = ['#9b59b6', '#8e44ad', '#3498db', '#2ecc71', '#e74c3c'];
                for (let i = 0; i < 100; i++) {
...
// Run on normal load
document.addEventListener('DOMContentLoaded', initMobileDevCourse);

// Run when SPA loads this page
document.addEventListener('page:loaded', (e) => {
  if (e.detail === 'mobile-page') {
    initMobileDevCourse();
  }
});
