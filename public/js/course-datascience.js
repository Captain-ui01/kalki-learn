function initDataScienceCourse() {
    document.addEventListener('DOMContentLoaded', function() {
            ...
            function createConfetti() {
                const colors = ['#007bff', '#28a745', '#ff6b6b', '#ffc107', '#17a2b8'];
                for (let i = 0; i < 100; i++) {
...
// Run on normal load
document.addEventListener('DOMContentLoaded', initDataScienceCourse);

// Run when SPA loads this page
document.addEventListener('page:loaded', (e) => {
  if (e.detail === 'datascience-page') {
    initDataScienceCourse();
  }
});
