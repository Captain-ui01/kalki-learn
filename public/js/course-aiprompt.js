        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            enrollButton.addEventListener('click', function(e) {
                ...
                setTimeout(() => {
                    ...
                    this.style.background = 'linear-gradient(135deg, #6741d9 0%, #9b59b6 100%)';
                    this.style.animation = 'glow 2s infinite';
                }, 3000);
            });
            
            function createConfetti() {
                const colors = ['#6741d9', '#9b59b6', '#3498db', '#2ecc71', '#f39c12'];
                for (let i = 0; i < 100; i++) {
...
// Run on normal load
document.addEventListener('DOMContentLoaded', initAIPromptCourse);
